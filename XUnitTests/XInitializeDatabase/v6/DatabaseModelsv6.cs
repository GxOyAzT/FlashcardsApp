...
{
    public class DatabaseModelsv6
    {
        public DatabaseModelsv6()
        {
        ...
        void InitializeGroupDbModels()
        {
            ...
            GroupDbModels.Add(new GroupDbModel()
            {
                ...
                Name = "Small-Group-5",
                Description = "",
                UserId = "a2c76aeb-94ff-4020-bc19-059877fe8705"
            });
        }
        void InitializeFlashcardDbModels()
        {
            ...
            FlashcardDbModels.Add(new FlashcardDbModel()
            {
                Id = Guid.Parse("2b134d1a-965d-4e97-888e-bdd64a044eb9"),
                PracticeDirection = PracticeDirection.FromNativeToForeign,
                NativeLanguage = "Flashcard 13 Native G5",
                ForeignLanguage = "Flashcard 13 Foreign G5",
                CorreactAnsInRow = null,
                NextPracticeDate = new DateTime(2020, 12, 1),
                GroupDbModelId = Guid.Parse("9098d9d1-48f6-4baf-b669-602e7f7efb4b")
            });
            ...
            FlashcardDbModels.Add(new FlashcardDbModel()
            {
                ...
                ForeignLanguage = "Flashcard 13 Foreign G5",
                CorreactAnsInRow = 4,
                NextPracticeDate = DateTime.Now.Date.AddDays(-5),
                GroupDbModelId = Guid.Parse("9098d9d1-48f6-4baf-b669-602e7f7efb4b")
            });
            ...
            FlashcardDbModels.Add(new FlashcardDbModel()
            {
                Id = Guid.Parse("be5f6658-18e7-49e3-9c61-b3a2e073042f"),
                PracticeDirection = PracticeDirection.FromNativeToForeign,
                NativeLanguage = "Flashcard 14 Native G5",
                ForeignLanguage = "Flashcard 14 Foreign G5",
                CorreactAnsInRow = 5,
                NextPracticeDate = DateTime.Now.Date.AddDays(5),
                GroupDbModelId = Guid.Parse("9098d9d1-48f6-4baf-b669-602e7f7efb4b")
            });
            ...
            FlashcardDbModels.Add(new FlashcardDbModel()
            {
                ...
                ForeignLanguage = "Flashcard 14 Foreign G5",
                CorreactAnsInRow = 4,
                NextPracticeDate = DateTime.Now.Date.AddDays(-1),
                GroupDbModelId = Guid.Parse("9098d9d1-48f6-4baf-b669-602e7f7efb4b")
            });
        }
